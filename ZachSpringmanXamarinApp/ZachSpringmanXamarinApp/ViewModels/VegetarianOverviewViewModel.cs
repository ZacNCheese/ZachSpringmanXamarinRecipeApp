...
{
    class VegetarianOverviewViewModel : ViewModelBase
    {
        ...
        public VegetarianOverviewViewModel()
        {
        ...
        async Task FillData()
        {
            ...
            var apiUrl = "https://www.themealdb.com/api/json/v1/1/filter.php?c=Vegetarian";
